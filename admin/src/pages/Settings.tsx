  ...
  return (
    <div className="page settings-page">
      ...
      <section className="settings-panel panel">
        ...
        <div className="account-action">
          <div>
            ...
            <div>
              ...
              <p>
                Password changes will be available when authentication is
                connected.
              </p>
            </div>
          </div>
          ...
          <button
            ...
            onClick={() =>
              showToast(
                'Password management is not available in this prototype'
              )
            }
          >
            Change Password
        ...
        <div className="account-action logout-action">
          <div>
            <span className="account-icon">
              <Icon name="logout" />
            </span>
            ...
            <div>
              ...
              <p>End this admin session on this device.</p>
            </div>
          </div>
