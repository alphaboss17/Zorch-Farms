...
const base = 'inline-flex items-center justify-center rounded-full transition duration-200 active:scale-[0.95] touch-manipulation disabled:pointer-events-none disabled:opacity-60'
...
const sizes: Record<Size, string> = { sm: 'p-1.5 min-h-[34px] min-w-[34px]', md: 'p-2 min-h-[40px] min-w-[40px]', lg: 'p-2.5 min-h-[44px] min-w-[44px]' }
